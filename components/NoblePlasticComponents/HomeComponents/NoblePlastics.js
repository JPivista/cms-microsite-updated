    ...
    return (
        <>
                ...
                <div className="lg:w-[1140px] w-full lg:p-0 p-2">
                    <div className="grid lg:grid-cols-12 grid-cols-1 gap-8">
                        ...
                        <div className="col-span-6 flex flex-col justify-center ">
                            <p className="text-[40px] text-[#7F3F97]">
                                Noble Plastics
                            </p>

                            <p className="text-[18px] mt-4 leading-6">
                                An eco-social initiative by the Catalyst Group that champions the effective use of plastic waste, while promoting the well-being of people and the planet.
                            </p>

                            <p className="text-[18px] mt-4 leading-6">
                                An incubation of the Catalyst Group, Noble Plastics works in line with the UN SDGs by integrating sustainability and social responsibility into supply chains across the apparel industry, while benefiting people and the planet.
                            </p>
                            <div>
                                <Link href="#" className="bg-[#7F3F97] px-8 py-3 text-white mt-8 inline-block rounded hover:bg-[#682b7d]">
                                    Learn More
                                </Link>
                            </div>
                        </div>
            ...
            <div className="flex justify-center py-8 bg-[#D0EAE2]">
                <div className="lg:w-[1140px] w-full lg:p-0 p-2">
                    <div>
                        <p className="text-[40px] text-[#7F3F97] text-center">
                            What Makes Us Unique
                        </p>

                        <p className="text-[18px] mt-6 leading-6 text-center">
                            The well-being of people, the planet and prosperity of all our <br className='lg:flex hidden' />
                            stakeholders lie at the heart of everything we do.
                        </p>

                        <div className='grid lg:grid-cols-12 grid-cols-1 gap-2 mt-10'>
                        ...
                        <div className='grid lg:grid-cols-12 grid-cols-1 lg:gap-10 gap-5 mt-10'>
                            <div className='col-span-4 flex flex-col justify-center items-center'>
