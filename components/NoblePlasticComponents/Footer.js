        ...
        <>
            ...
            <div className="flex justify-center py-10 bg-[#05AC8D]">
                <div className="lg:w-[1140px] w-full lg:p-0 p-2">
                    ...
                    <div className='grid lg:grid-cols-12 grid-cols-4 justify-center items-center gap-6 py-5'>
            ...
            <div className="flex justify-center py-10 bg-[#7F3F97]">
                <div className="lg:w-[1140px] w-full lg:p-0 px-4">
                    <div className='grid lg:grid-cols-12 grid-cols-1'>
                        <div className='col-span-6 flex flex-col gap-5 justify-center mb-4'>
                            <img src='https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/nobleplasics/home/noble_plastic_logo_white.png' className='w-[50%]' />

                            <p className="text-[18px] text-white text-start">
                                This initiative has been supported by an Impact Investors and fashion retailers.
                            </p>
                            <p className="text-[18px] text-white text-start">
                                Fuzhio Health and Business Services Pvt. Ltd. No. 25, RMV 2nd Stage, AECS Layout, 1st Main Road, Ashwathnagar, Bangalore – 560094
                            </p>
                        ...
                        <div className='col-span-6' id="contact" >
                            <NoblePlasticForm />
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:w-[1140px] w-full lg:p-0 px-4">
                    <div className="flex space-x-4 flex-row justify-center items-center gap-3">
                        ...
                        <a href="/shoonya/noble-plastics/approach/"
                            className='text-white '>Approach</a>
                        <a href="/shoonya/noble-plastics/work/"
                            className='text-white '>Work</a>
                        <a href="/shoonya/noble-plastics/impact/"
                            className='text-white ' >Impact</a>
                    </div>
                </div>
            </div>
        </>
